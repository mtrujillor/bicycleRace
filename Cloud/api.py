...
""" test 1 Database connection settings HEROKU
app.config["MONGODB_DB"] = 'cc_OkRsKkkQunCc'
connect(
    'cc_OkRsKkkQunCc',
    username='OkRsKkkQunCc',
    password='VYQVFGzAhMtL',
    host='mongodb://OkRsKkkQunCc:VYQVFGzAhMtL@mongosoup-cont002.mongosoup.de:32459/cc_OkRsKkkQunCc',
    port=32459
)"""

""" test 2 Database connection settings HEROKU
app.config["MONGODB_HOST"] = 'mongosoup-cont002.mongosoup.de:32459/cc_OkRsKkkQunCc'
app.config["MONGODB_PORT"] = 32459
app.config["MONGODB_DATABASE"] = 'cc_OkRsKkkQunCc'
app.config["MONGODB_USERNAME"] = 'OkRsKkkQunCc'
app.config["MONGODB_PASSWORD"] = 'VYQVFGzAhMtL'"""

""" test 3 Database connection settings HEROKU"""
dbName = 'cc_OkRsKkkQunCc'
dbHost = 'mongodb://OkRsKkkQunCc:VYQVFGzAhMtL@mongosoup-cont002.mongosoup.de:32459/cc_OkRsKkkQunCc'
app.config["MONGODB_SETTINGS"] = {'DB': dbName, "host":dbHost}
db = MongoEngine(app)
